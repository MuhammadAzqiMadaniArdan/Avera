...
class UpdateStoreVoucherRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            "code" => "nullable|string|unique:promotions,code|min:3|max:100|regex:/^[\pL\pN\s\-\.\']+$/u/",
            "type" => "sometimes|in:free_shipping,cashback,discount",
            ...
            "usage_limit_per_user" => "sometimes|numeric|min:1|max_digits:9",
